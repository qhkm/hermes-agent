...
# Configuration
REPO_URL_SSH="git@github.com:qhkm/hermes-agent.git"
REPO_URL_HTTPS="https://github.com/qhkm/hermes-agent.git"
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        -h|--help)
            ...
            echo "  --force-commit Allow --commit to roll an existing checkout backwards"
